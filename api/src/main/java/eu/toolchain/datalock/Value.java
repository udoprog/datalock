...
public interface Value {
    ...
    static Value fromPb(final com.google.datastore.v1beta3.Value pb) {
        final boolean excludeFromIndexes = pb.getExcludeFromIndexes();

        final com.google.datastore.v1beta3.Value.ValueTypeCase c = pb.getValueTypeCase();
    ...
    class EntityValue implements Value {
        ...
        @Override
        public com.google.datastore.v1beta3.Value toPb() {
            return com.google.datastore.v1beta3.Value
                .newBuilder()
    ...
    class ArrayValue implements Value {
        ...
        @Override
        public com.google.datastore.v1beta3.Value toPb() {
            final com.google.datastore.v1beta3.Value.Builder valueBuilder =
                com.google.datastore.v1beta3.Value.newBuilder();
            com.google.datastore.v1beta3.ArrayValue.Builder array =
                com.google.datastore.v1beta3.ArrayValue.newBuilder();
    ...
    class IntegerValue implements Value {
        ...
        @Override
        public com.google.datastore.v1beta3.Value toPb() {
            return com.google.datastore.v1beta3.Value.newBuilder().setIntegerValue(value).build();
        }
    ...
    class DoubleValue implements Value {
        ...
        @Override
        public com.google.datastore.v1beta3.Value toPb() {
            return com.google.datastore.v1beta3.Value.newBuilder().setDoubleValue(value).build();
        }
    ...
    class BooleanValue implements Value {
        ...
        @Override
        public com.google.datastore.v1beta3.Value toPb() {
            return com.google.datastore.v1beta3.Value.newBuilder().setBooleanValue(value).build();
        }
