...
public class PropertyOrder {
    ...
    public com.google.datastore.v1beta3.PropertyOrder toPb() {
        final com.google.datastore.v1beta3.PropertyOrder.Builder builder = com.google.datastore.v1beta3.PropertyOrder.newBuilder();
        builder.setProperty(com.google.datastore.v1beta3.PropertyReference.newBuilder().setName(field).build());
