...
public interface Mutation {
    com.google.datastore.v1beta3.Mutation toPb();

    static Mutation delete(final Key key) {
        return new DeleteMutation(key);
    }

    static Mutation insert(final Entity entity) {
        return new InsertMutation(entity);
    }

    static Mutation upsert(final Entity entity) {
        return new UpsertMutation(entity);
    }

    static Mutation update(Entity entity) {
    ...
    class DeleteMutation implements Mutation {
        ...
        @Override
        public com.google.datastore.v1beta3.Mutation toPb() {
            final com.google.datastore.v1beta3.Mutation.Builder builder =
