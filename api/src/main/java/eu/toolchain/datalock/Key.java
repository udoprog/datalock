...
public class Key {
    ...
    public com.google.datastore.v1beta3.Key toPb() {
        final com.google.datastore.v1beta3.Key.Builder builder =
    ...
    public static Key fromPb(final com.google.datastore.v1beta3.Key pb) {
